...
export const TransactionsTable = () => {
  ...
  const TableRow = (props) => {
    const { invoiceNumber, date, transaction_Time, transaction_id, transcation_Type,amount,desc,balance } = props;
    ...
    return (
      <tr>
        <td>
          <Card.Link as={Link} to={dashboardRoutes.Invoice.path} className="fw-normal">
            {invoiceNumber}
          </Card.Link>
        </td>
        <td>
  ...
  const thead=["#","Date","Transaction Time","Transaction Id","Transaction Type","Amount","Description","Balance"];
